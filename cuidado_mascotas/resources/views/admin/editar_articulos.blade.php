...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5">
        <form method="POST" action="/editar_articulos/{$Id}" class="p-4 p-md-5 border rounded-3 bg-light">
        @csrf
    @method('PATCH')
        ...
        <div class="form-floating mb-3">
          ...
          <textarea class="form-control" name="content" value="{{ old('content', optional($article)->content)}}" id="content" rows="3"></textarea>
